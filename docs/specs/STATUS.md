...
| 75 | settings-provider-list-fixes | Fix "N of 0 selected" providers on Settings entry + make the provider list collapsible | implementing | slice:settings | scope:mobile |
