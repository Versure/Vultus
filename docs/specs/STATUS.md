...
| 79 | fix-region-display-names | Display human-readable region names (endonyms) in Settings instead of raw ISO codes | implementing | slice:settings, slice:onboarding | scope:shared, scope:mobile |
